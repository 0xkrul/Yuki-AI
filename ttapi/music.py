...
class Music:
    ...
    async def get_videos_by_music(self, music_id, cursor="0", count="20", region="US"):
        ...
        for video in res["aweme_list"]:
            videos["videos"].append(await self.api.video.video_data_formatter(video))
        return videos        
